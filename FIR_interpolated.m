...
fh3=fftshift(20*log10(abs(fft(g1,1024))));

fh2 =fftshift(20*log10(abs(fft(h4,1024))));

subplot(3,1,2)
plot([-0.5:1/1024:0.5-1/1024]*fs2,fh2,'b','linewidth',2)
hold on
plot([-0.5:1/1024:0.5-1/1024]*fs2,fh3,'--r','linewidth',2)
hold off
grid on
axis([-20 +20 -120 10])
title('Frequency Response of g1 and h4')
