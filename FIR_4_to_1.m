...
plot([-0.5:1/1024:0.5-1/1024]*fs,fh,'b','linewidth',2)
hold on
plot([-7.5 -7.5 7.5 7.5],[-0.1 -0.00066 -0.00066 -0.1],'--r','linewidth',2) %first box is the length, second is the position, [ | _ _ | ] 
plot([-7.9 -7.9 7.9 7.9],[+0.1 +0.00079 +0.00079 +0.1],'--r','linewidth',2)
hold off
grid on
